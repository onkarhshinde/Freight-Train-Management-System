		...
		<div class="container-fluid">
			...
			<ul class="nav navbar-nav">
				...
				<li class="nav-item active">
					<a class="nav-link" href="#"><b>Cancelled cargos</b></a>
				</li>
           	</ul>
		...
		<div class="table table-responsive">
			<div class="table-wrapper">
				<div class="table-title">
					<div class="row">
						<div class="col-xs-6">
							<h2>Cancelled cargo Details</h2>
						</div>
						<div class="col-xs-6">
							<input type="text"  id="myInput" style="width:80%;color: black;" onkeyup="myFunction()" placeholder="Search using PNR Number, User ID, Train Number,Date">
						</div>
					</div>
				</div>
				<table class="table table-striped table-hover text-center table-bordered" id="myTable">
					...
					<tbody>
						<?php
							...
							$query="SELECT * FROM reservation,cancel_cargo where cargo_status='CANCELLED' AND reservation.pnr_number=cancel_cargo.pnr_number";
