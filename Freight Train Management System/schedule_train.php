						...
						<div class=\"table table-responsive\">
							<div class=\"table-wrapper\">
								...
								<table class=\"table table-striped table-hover text-center table-bordered\">
									...
									<th style=\"text-align:center;\">Oil tanker</th>
									<th style=\"text-align:center;\">Gas tanker</th>
									<th style=\"text-align:center;\">Car carrier</th>
									<th style=\"text-align:center;\">Solid Goods</th>
									<th style=\"text-align:center;\">Coal carrier</th>
									<th style=\"text-align:center;\">Industrial goods</th>
...
echo "
			...
			echo "
 									<tr>
										...
										<td><input onkeypress=\"return onlyNumberKey(event)\" style=\"text-align:center;\" type=\"text\" name=\"f1"."\" value=\"0\" required></td>
										<td><input onkeypress=\"return onlyNumberKey(event)\" style=\"text-align:center;\" type=\"text\" name=\"f2"."\" value=\"0\" required></td>	
										<td><input onkeypress=\"return onlyNumberKey(event)\" style=\"text-align:center;\" type=\"text\" name=\"f3"."\" value=\"0\" required></td>
										<td><input onkeypress=\"return onlyNumberKey(event)\" style=\"text-align:center;\" type=\"text\" name=\"f4"."\" value=\"0\" required></td>
										<td><input onkeypress=\"return onlyNumberKey(event)\" style=\"text-align:center;\" type=\"text\" name=\"f5"."\" value=\"0\" required></td>
										<td><input onkeypress=\"return onlyNumberKey(event)\" style=\"text-align:center;\" type=\"text\" name=\"f6"."\" value=\"0\" required></td>
																			</tr>
					";

// !-- dsfjhsdkjfdkgjsdklgjskdjfgnskjdfgnsfkjdsgkjfbnskjbnskfjnbskfjngsfgbnsfkghjnfskjhnskfbnksjfgnblskfbglnskfbgksfs--!
					            	...
					            	<div class=\"container-fluid\">
					                	...
					                	<ul class=\"nav navbar-nav\">
							                ...
							                <li class=\"nav-item\">
					                  		...
					                  		<li class=\"nav-item\">
					                    		<a class=\"nav-link\" href=\"http://localhost/railway/cargos_booked.php\"><b>Booked cargos</b></a>
					                  		</li>
					                  		<li class=\"nav-item\">
					                    		<a class=\"nav-link\" href=\"http://localhost/railway/cargos_cancelled.php\"><b>Cancelled cargos</b></a>
					                  		</li>
                						</ul>
