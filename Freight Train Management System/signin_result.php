      ...
      $_SESSION["id"]=$temp2;
    	...
    	if(mysqli_num_rows($query2) == 0)
    	{
    		echo "
              <div class=\"alert alert-danger alert-dismissible\">
                  ...
                  <strong>No cargo booked from this account </strong> <i class=\"far fa-frown\"></i>.
              </div>
              <div class=\"text-center\">
                <a class=\"font-weight-bold text-dark\"href=\"http://localhost/railway/index.html\"> 
                  <strong><i class='fa fa-home'></i> Go to home page</strong>
        ...
        ";
      	...
      	echo "
              ...
              <br>
              <span>
                <form action=\"http://localhost/railway/cancel_cargo.php\" method=\"post\">
                  ...
                  <input type=\"submit\" class=\"btn btn-danger text-dark\" value=\"Cancel cargo\">
                </form>
              </span>
        ";
    	}
