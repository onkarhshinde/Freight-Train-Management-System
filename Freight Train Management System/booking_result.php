    ...
    if($sp == $dp)
    {
      echo "
              ...
              <div class=\"text-center\">
                  <a  style=\"margin-right: 3%;\" href=\"http://localhost/railway/book_cargo.php\">
                ...
                <table class=\"table table-striped table-hover text-center table-bordered\" id=\"myTable\">
                  <thead>
                    <tr>
                      ...
                      <th class=\"text-center\">cargo Fare (Per boggie)</th>
                      <th class=\"text-center\">Available cargo</th>
                    </tr>
                  </thead>
                  <tbody>
      ";
