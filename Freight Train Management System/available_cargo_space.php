                ...
                <table class=\"table table-striped table-hover text-center table-bordered\" id=\"myTable\">
                  <thead>
                  	<th class=\"text-center\" style=\"width:8%\">Sr. No.</th>
										...
										<th class=\"text-center\" style=\"width:23%\">cargo Class </th>
										<th class=\"text-center\" style=\"width:23%\">Available Space </th>
										<th class=\"text-center\" style=\"width:23%\">Fare (Single Quantity)</th>
									</thead>
									<tbody>
		";

		$cdquery="SELECT classcargo.journey_date,classcargo.class_name,classcargo.available_cargo,classcargo.cargo_fare1 FROM classcargo WHERE classcargo.train_number='".$_GET["trainno"]."' AND classcargo.start_point='".$_GET["sp"]."' AND classcargo.destination_point='".$_GET["dp"]."'";
