...
<body>
  <?php 
        ...
        <nav class=\"navbar navbar-inverse\">
              <div class=\"container-fluid\">
                ...
                <ul class=\"nav navbar-nav\">
                  ...
                  <li class=\"active\">
                    <a class=\"nav-link\" href=\"#\"><b>Cancel cargo</b></a>
                  </li>
                                   <li class=\"nav-item\">
    ...
    if($row = mysqli_fetch_array($query))
    {
      ...
      $temp4=$row['lname'];
      $_SESSION["id"]=$temp2;
      //$query2 = mysqli_query($conn," SELECT * from user_details,reservation where user_details.user_id=reservation.user_id AND  user_details.mobile_number=BINARY $mobile AND reservation.cargo_status='BOOKED' and reservation.journey_date>=CURDATE() ORDER BY reservation.journey_date") or die(mysql_error());

    	$query2 = mysqli_query($conn," SELECT * from user_details,reservation where user_details.user_id=reservation.user_id AND  user_details.mobile_number=BINARY $mobile AND reservation.cargo_status='BOOKED' ORDER BY reservation.journey_date") or die(mysql_error());
    	if(mysqli_num_rows($query2) == 0)
    	{
    		echo "
              <div class=\"alert alert-danger alert-dismissible\">
                  ...
                  <strong>No Upcoming journey cargo booked from this account </strong> <i class=\"far fa-frown\"></i>.
              </div>
            ";
                      ...
                      <div class=\"table-wrapper\">
                        ...
                        <thead>
                          <tr>
                            ...
                            <th class=\"text-center\">cargo Class</th>
                            <th class=\"text-center\">Number Of Cargos</th>
      	...
      	while($row = mysqli_fetch_array($query2))
      	{
        		echo "
                  <tr>
                    ...
                    <td>".$row["number_of_Cargo"]."</td>
                    <td>".$row["cargo_fare1"]."</td>
                    
                    <td>".$row["cargo_status"]."</td>
                    <td>

                      <a href=\"http://localhost/railway/cancel_cargo_result_1.php?cancpnr=".$row["pnr_number"]."\">
                          <button class=\" btn btn-sm text-dark rounded btn-danger\">Cancel cargo</button>
                      </a>
                    </td>
                  </tr>
            ";
