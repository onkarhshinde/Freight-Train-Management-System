...
<body>
    <?php 
        ...
        if(mysqli_num_rows($query) == 0)
        {
            echo "
                    ...
                    <div class=\"text-center\">
                        <a href=\"http://localhost/railway/booking_result_1.php?doj=".$doj."&sp=".$_SESSION["sp"]."&dp=".$_SESSION["dp"]."\" class=\" text-dark font-weight-bold\">
        ...
        $nos=$_POST["nos"];
        $_SESSION["nos"] = "$nos";
        $query2 = mysqli_query($conn,"SELECT available_cargo FROM classcargo WHERE classcargo.journey_date= '$doj' AND classcargo.train_number= $tno AND classcargo.class_name= '$class' AND classcargo.start_point= '".$_SESSION["sp"]."'  AND classcargo.destination_point= '".$_SESSION["dp"]."'; ") or die(mysql_error());
        ...
        if(  $nos>=10 )
        {
            echo "
                    <div class=\"alert alert-sm alert-danger alert-dismissible\">
                        ...
                        <strong>Maximum Ten bookings allowed at a time.</strong> <i class=\"fa fa-frown-o\"></i>.
                    </div>
                    <div class=\"text-center\">
                        <a href=\"http://localhost/railway/booking_result_1.php?doj=".$doj."&sp=".$_SESSION["sp"]."&dp=".$_SESSION["dp"]."\" class=\" text-dark font-weight-bold\">
                          <button class=\"btn btn-primary text-dark p-2\" style=\"margin-right: 20px;\"> 
        ...
        if( (mysqli_num_rows($query2)> 0) && ($nos>=$row11[0]) )
        {
            echo "
                    <div class=\"alert alert-sm alert-danger alert-dismissible\">
                        ...
                        <strong>Number of cargo you are looking are not available at the moment.</strong> <i class=\"fa fa-frown-o\"></i>.
                    </div>
                    <div class=\"text-center\">
                        <a href=\"http://localhost/railway/booking_result_1.php?doj=".$doj."&sp=".$_SESSION["sp"]."&dp=".$_SESSION["dp"]."\" class=\" text-dark font-weight-bold\">
                          <button class=\"btn btn-primary text-dark p-2\" style=\"margin-right: 20px;\"> 
        ...
        if(mysqli_num_rows($query2) == 0)
        {
            echo "
                    <div class=\"alert alert-sm alert-danger alert-dismissible\">
                        ...
                        <strong>Selected cargo Class is not present.</strong> <i class=\"fa fa-frown-o\"></i>.
                    </div>
                    <div class=\"text-center\">
                        <a href=\"http://localhost/railway/booking_result_1.php?doj=".$doj."&sp=".$_SESSION["sp"]."&dp=".$_SESSION["dp"]."\" class=\" text-dark font-weight-bold\">
                          <button class=\"btn btn-primary text-dark p-2\" style=\"margin-right: 20px;\"> 
        ...
        echo"
                <div class=\"container-sm\">
                    <form action=\"http://localhost/railway/reservation_results_new.php\" method=\"post\">
                        <div class=\"table table-responsive\">
                            <div class=\"table-wrapper\">
                                ...
                                <table class=\"table table-striped table-hover text-center table-bordered\">
                                    <thead>
                                        <tr>
                                            <th class=\"text-center\" style=\"width:33%;\">cargo Name</th>
        ...
        echo "
                        ...
                        <div class=\"text-center\" style=\"margin-top:-20px;\">
                            <input type=\"submit\" name=\"submit\" class=\" btn btn-primary\" style=\"margin-right: 4%;\" value=\"BOOK cargo\">
    ...
    <div class="text-center" style="margin-top:30px;">
        <?php
                echo"
                    <a href=\"http://localhost/railway/booking_result_1.php?doj=".$doj."&sp=".$_SESSION["sp"]."&dp=".$_SESSION["dp"]."\"  style=\" font-size:15px;margin-right:25px;margin-top:30px;\">
