			...
			while($j<$count)
			{
				echo "
										<tr>	
											...
											<td>
												<a href=\"http://localhost/railway/available_cargo_space.php?trainno=".$_GET["trainno"]."&sp=".$stations[$i]."&dp=".$stations[$j]."\">
													<button class=\"btn btn-sm btn-info\">Available Cargo Space</button>
												</a>
											</td>
										</tr>
				";
